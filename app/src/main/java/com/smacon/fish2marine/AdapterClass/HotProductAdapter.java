...
public class HotProductAdapter extends RecyclerView.Adapter<HotProductAdapter.ViewHolder> {
    ...
    public HotProductAdapter(Activity context, ArrayList<ProductListItem> listitem, String CustomerID) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
      ...
      //  Log.d("11111111","hiii"+mListItem.get(position).getbestCuttype_valuelist());
        ...
        holder.txt_ordered_qty.setText("Ordered Qty: "+item.getbestsellerorder_qty());
        holder.txt_cleaned_qty.setText("After Cleaning: "+item.getbestsellercleaned_qty());

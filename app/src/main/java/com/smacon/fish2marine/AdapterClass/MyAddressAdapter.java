...
public class MyAddressAdapter extends RecyclerView.Adapter<MyAddressAdapter.ViewHolder>  {
    ...
    MyAddressFragment.AddressUpdateListner addressUpdateListner;

    public MyAddressAdapter(Activity context, ArrayList<AddressListItem> listitem, MyAddressFragment.AddressUpdateListner addressUpdateListner) {
        this.mContext = context;
        this.mListItem = listitem;
        this.addressUpdateListner=addressUpdateListner;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_address, viewGroup, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        private CustomTextView txt_address_name,txt_company,txt_street,
                txt_city,txt_state_pin,txt_country,txt_phone,txt_default_address;
    ...
    private void processEditAddress(String customerid,String fname,String lname,String company,String add1,String add2,
        ...
        if(mConfig.isOnline(mContext.getApplicationContext())){

 ...
 */
public class CuttypesListAdapterNew extends BaseAdapter {
    private Context mcontext;
    private ArrayList<ProductListItem> listitem;

    public CuttypesListAdapterNew(Context context, ArrayList<ProductListItem> mListitem, String ID, String Quantity) {

package com.smacon.f2mlibrary.SwipableLayout;
...
import static com.smacon.f2mlibrary.SwipableLayout.Utils.getViewWeight;
import static com.smacon.f2mlibrary.SwipableLayout.Utils.setTint;
import static com.smacon.f2mlibrary.SwipableLayout.Utils.setViewWidth;
...
public class SwipeLayout extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void setUpAttrs(AttributeSet attrs) {
        final TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.SwipeLayouts);
        if (array != null) {
            layoutId = array.getResourceId(R.styleable.SwipeLayouts_foregroundLayout, NO_ID);
            itemWidth = array.getDimensionPixelSize(R.styleable.SwipeLayouts_swipeItemWidth, 100);
            iconSize = array.getDimensionPixelSize(R.styleable.SwipeLayouts_iconSize, ViewGroup.LayoutParams.MATCH_PARENT);
            textSize = array.getDimensionPixelSize(R.styleable.SwipeLayouts_textSize, NO_ID);
            textTopMargin = array.getDimensionPixelSize(R.styleable.SwipeLayouts_textTopMargin, 20);
            canFullSwipeFromRight = array.getBoolean(R.styleable.SwipeLayouts_canFullSwipeFromRight, false);
            canFullSwipeFromLeft = array.getBoolean(R.styleable.SwipeLayouts_canFullSwipeFromLeft, false);
            onlyOneSwipe = array.getBoolean(R.styleable.SwipeLayouts_onlyOneSwipe, true);
            autoHideSwipe = array.getBoolean(R.styleable.SwipeLayouts_autoHideSwipe, true);

            int rightColorsRes = array.getResourceId(R.styleable.SwipeLayouts_rightItemColors, NO_ID);
            int rightIconsRes = array.getResourceId(R.styleable.SwipeLayouts_rightItemIcons, NO_ID);

            int leftColorsRes = array.getResourceId(R.styleable.SwipeLayouts_leftItemColors, NO_ID);
            int leftIconsRes = array.getResourceId(R.styleable.SwipeLayouts_leftItemIcons, NO_ID);

            int leftTextRes = array.getResourceId(R.styleable.SwipeLayouts_leftStrings, NO_ID);
            int rightTextRes = array.getResourceId(R.styleable.SwipeLayouts_rightStrings, NO_ID);

            int leftTextColorRes = array.getResourceId(R.styleable.SwipeLayouts_leftTextColors, NO_ID);
            int rightTextColorRes = array.getResourceId(R.styleable.SwipeLayouts_rightTextColors, NO_ID);

            int leftIconColors = array.getResourceId(R.styleable.SwipeLayouts_leftIconColors, NO_ID);
            int rightIconColors = array.getResourceId(R.styleable.SwipeLayouts_rightIconColors, NO_ID);


            String typefaceAssetPath = array.getString(R.styleable.SwipeLayouts_customFont);
    ...
    private void collapseItem(boolean animated) {
        if (leftLinear != null && leftLinear.getWidth() > 0) {
            ...
            setViewWidth(leftLinearWithoutFirst, leftViews.length - 1);

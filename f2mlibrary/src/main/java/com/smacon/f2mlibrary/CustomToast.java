...
import com.smacon.f2mlibrary.Helperclasses.Utils;
...
public class CustomToast {
    ...
    private static final @ColorInt int WARNING_COLOR = Color.parseColor("#3F51B5");
    ...
    public static @CheckResult Toast custom(@NonNull Context context, @NonNull String message, @DrawableRes int iconRes,
        ...
        return custom(context, message, Utils.getDrawable(context, iconRes), textColor,
